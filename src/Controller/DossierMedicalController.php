...
class DossierMedicalController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, DossierMedicalRepository $dossierMedicalRepository): Response
    {
    ...
    {
        if ($this->isCsrfTokenValid('delete'.$dossierMedical->getId(), $request->getPayload()->get('_token'))) {
